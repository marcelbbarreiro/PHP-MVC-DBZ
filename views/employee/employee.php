            ...
            <div class="form-row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input required type="text" value="<?php echo isset($employee[0]['name']) ? $employee[0]['name'] : null ?>" class="form-control" id="name" name="name" aria-describedby="name" placeholder="Enter name">
                    </div>
